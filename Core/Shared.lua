...
addon.Constants = {
	...
	ESSENTIAL_BASE_ICON_SIZE = 50,
	UTILITY_BASE_ICON_SIZE = 30,
	DEFAULT_BAR_SIZE_PERCENT = 100,
	DEFAULT_BAR_PADDING = 2,
	DEFAULT_BAR_OPACITY = 100,
	BLIZZARD_COOLDOWN_VIEWER_PADDING_OFFSET = -4,
	BAR_VISIBILITY_ALWAYS = "always",
	BAR_VISIBILITY_IN_COMBAT = "in_combat",
	BAR_VISIBILITY_HIDDEN = "hidden",
	BAR_MATCH_MANUAL = "manual",
	BAR_MATCH_ESSENTIAL = "match_essential",
	BAR_MATCH_UTILITY = "match_utility",
	GROWTH_LEFT = "left",
		...
		bars = {
			{
				...
				x = 0,
				y = -180,
				sizePercent = addon.Constants.DEFAULT_BAR_SIZE_PERCENT,
				padding = addon.Constants.DEFAULT_BAR_PADDING,
				opacity = addon.Constants.DEFAULT_BAR_OPACITY,
				visibility = addon.Constants.BAR_VISIBILITY_ALWAYS,
				matchMode = addon.Constants.BAR_MATCH_MANUAL,
				iconSize = addon.Constants.ESSENTIAL_BASE_ICON_SIZE,
				spacing = addon.Constants.DEFAULT_BAR_PADDING,
