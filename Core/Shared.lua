...
addon.Constants = {
	...
	ANCHOR_TARGET_SCREEN = "screen",
	ANCHOR_TARGET_ESSENTIAL = "essential",
	ANCHOR_TARGET_UTILITY = "utility",
	ANCHOR_SIDE_LEFT = "left",
	ANCHOR_SIDE_RIGHT = "right",
	ANCHOR_SIDE_TOP = "top",
	ANCHOR_SIDE_BOTTOM = "bottom",
	GROWTH_LEFT = "left",
		...
		bars = {
			{
				...
				iconSize = 40,
				spacing = 6,
				anchorTarget = addon.Constants.ANCHOR_TARGET_SCREEN,
				anchorSide = addon.Constants.ANCHOR_SIDE_BOTTOM,
